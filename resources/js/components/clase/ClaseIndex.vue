...
import {mapActions} from "vuex";
  export default {
    ...
    methods:{
        ...
        create(){
            this.$router.push({ name: 'clase.create'})
        },
        editItem (id) {
            this.setPagination(this.paginaActual);
            this.$router.push({ name: 'clase.edit', params: { id: id } })
        },
        openDialog (id){
            this.dialog = true;
            this.clase_id = id;
        ...
        destroyReg () {
            ...
            axios.post('/mto/clases/'+this.clase_id,{_method: 'delete'})
                .then(response => {
