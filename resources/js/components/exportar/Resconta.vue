    ...
    <div>
        <v-card>
            ...
            <v-card-title color="indigo">
                <h2 color="indigo">Resumen Contable</h2>
                <v-spacer></v-spacer>
                <v-tooltip bottom>
                        ...
                        <v-flex xs12>
                            ...
                            >
                                <template slot="items" slot-scope="props">
                                    <tr v-if="props.item.nom_com != null">
                                        <td>{{props.item.nom_com}}</td>
                                        ...
                                        <td class="text-xs-right">{{ beneficio(props.item) | currency('€', 2, { thousandsSeparator:'.', decimalSeparator: ',', symbolOnLeft: false })}}</td>
...
export default {
    ...
    methods:{
        clase(item){
            if (item.quilates > 0)
                return item.clase + " " + item.quilates+ " K";
            else
                return item.clase;
        },
        beneficio(item){
