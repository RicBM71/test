                 ...
                 <v-container>
                     <v-layout row wrap>
                        ...
                        <v-flex sm2>
                            ...
                            v-validate="'required'"
                            data-vv-name="tipo_factura"
                            data-vv-as="serie"
                            :error-messages="errors.collect('tipo_factura')"
                            :items="tipos_factura"
                            label="Serie"
                            ></v-select>
                        </v-flex>
...
import {mapActions} from "vuex";
	...
	export default {
    	...
    	data () {
      		return {
                menu1: false,
                url: "/ventas/facturacion/albaranes/listar",
                ruta: "albaran",
                ...
                tipos:[],
                tipos_factura:[
                    {value: 1, text: 'Serie Manual'},
                    {value: 2, text: 'Serie Automática'},
                    {value: 3, text: 'Serie Abonos'},
                ],
                tipo_factura: 1,
                lineas:[],
                ...
                show: false,
                show_loading: true,
                titulo:'Relación de facturas de ventas',
            ...
            goExcel(){
                ...
                axios({
                        ...
                        .then(response => {
                            ...
                            this.$toast.success('Facturas generadas correctamente'+link.download);
