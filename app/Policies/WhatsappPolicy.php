...
class WhatsappPolicy
{
    ...
    public function __construct()
    {
     ...
     public function create(User $authUser, Whatsapp $whatsapp)
     {

         return $authUser->hasRole('Admin') ?: $this->deny("Acceso denegado. Permiso administrador requerido");

     }
     public function update(User $authUser, Whatsapp $whatsapp)
     {

         return $authUser->hasRole('Admin') ?: $this->deny("Acceso denegado. Permiso administrador requerido");

     }
     public function delete(User $authUser, Whatsapp $whatsapp)
     {
